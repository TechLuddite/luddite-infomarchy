...
### Added
- **MEDIA CONTROLS.** Last card in the right column. Live MPRIS title, artist, album, and player identity, with PREV / PLAY or PAUSE / NEXT. Prefers a playing player over `playerctld`. No album-art URL. Stream privacy hides title and artist. Not on the phone page.
