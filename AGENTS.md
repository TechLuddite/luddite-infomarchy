...
Read `README.md` and `docs/HANDOFF.md` before changing Web Mode, USAGE, LOCAL AI, privacy, CONTAINERS, or MEDIA CONTROLS. For Web Mode, also read `docs/WEB-MODE-SECURITY.md` for the implemented boundaries and rationale. README owns user setup instructions; HANDOFF owns the source map and verification record; TODO owns remaining work. Scope: LAN HTTP plus guided Tailscale Serve, desktop-owned privacy enforced server-side; no built-in certificate management or public exposure workflow.
